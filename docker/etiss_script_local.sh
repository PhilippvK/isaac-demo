...
date
export ETISS_HOME=${ETISS_HOME:-/tmp/etiss_local}  # TODO: tempdir?
...
cmake -B build -S . -DCMAKE_INSTALL_PREFIX=$DEST/etiss_install -DCMAKE_BUILD_TYPE=Release $CCACHE_ARGS
