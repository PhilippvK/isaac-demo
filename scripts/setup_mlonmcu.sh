...
MLONMCU_TEMPLATE=${MLONMCU_TEMPLATE:-$TOP_DIR/environment.yml.j2}
MLONMCU_HOME=${MLONMCU_HOME:-$INSTALL_DIR/mlonmcu}
ETISS_DIR=${ETISS_DIR:-$TOP_DIR/etiss}
ETISS_INSTALL_DIR=${ETISS_INSTALL_DIR:-$INSTALL_DIR/etiss}
LLVM_INSTALL_DIR=${LLVM_INSTALL_DIR:-$INSTALL_DIR/llvm}
